<section class="category-devices">
    <a href="/device" class="tile tile_small" data-device="macbook">
        <svg class="tile__icon">
            <use xlink:href="/images/stack/sprite.svg#macbook"></use>
        </svg>
        <span class="tile__text">На MacBook</span>
    </a>
    <a href="/device" class="tile tile_small" data-device="imac">
        <svg class="tile__icon">
            <use xlink:href="/images/stack/sprite.svg#imac"></use>
        </svg>
        <span class="tile__text">На iMac</span>
    </a>
    <a href="/device" class="tile tile_small" data-device="iphone">
        <svg class="tile__icon">
            <use xlink:href="/images/stack/sprite.svg#iphone"></use>
        </svg>
        <div class="tile__text">На iPhone</div>
    </a>
    <a href="/device" class="tile tile_small" data-device="ipad">
        <svg class="tile__icon">
            <use xlink:href="/images/stack/sprite.svg#ipad"></use>
        </svg>
        <div class="tile__text">На iPad</div>
    </a>
    <a href="/device" class="tile tile_small" data-device="apple-watch">
        <svg class="tile__icon">
